...
public class LeftAndRightRefreshActivity extends AppCompatActivity {
    private static final String TAG = "LeftAndRightRefreshActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_left_and_right_refresh);
        ...
        kLineLayout.setKLineHandler(new KLineHandler() {
            ...
            public void onSingleTap(MotionEvent e, float x, float y) {
                ...
                if (kLineRender.getKLineRect().contains(x, y)) {
                    Toast.makeText(LeftAndRightRefreshActivity.this, "single tab [" + x + ", " + y + "]", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onLeftRefresh() {
                ...
                kLineLayout.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (entries.size() == 0) {
                            Toast.makeText(LeftAndRightRefreshActivity.this, "已经到达最左边了", Toast.LENGTH_SHORT).show();
                        }
                    }
                }, 1000);
            }
            ...
            public void onRightRefresh() {
                ...
                kLineLayout.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (entries.size() == 0) {
                            Toast.makeText(LeftAndRightRefreshActivity.this, "已经到达最右边了", Toast.LENGTH_SHORT).show();
                        }
                    }
                }, 1000);
            }
    ...
    public static Intent createIntent(Context context) {
        Intent intent = new Intent(context, LeftAndRightRefreshActivity.class);
        return intent;
    }
}
